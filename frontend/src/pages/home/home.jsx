...
export const Home = () => {
  return (
    <div className="flex w-full h-screen contain bg-gradient-to-r from-blue-100 via-white to-blue-50">
      {/* Left Section */}
      <div className="w-full bg-primary md:flex flex-col gap-6 p-24 justify-center items-center hidden bg-gradient-to-r from-blue-400 to-blue-600 text-white">
        <Homeimage />
        <p className="text-gray-200 font-medium text-lg w-3/4 text-center leading-relaxed">
          Your generous donation helps provide essential support and create meaningful changes in people's lives.
        </p>
      </div>

      {/* Right Section */}
      <div className="md:w-1/2 w-full flex flex-col items-center justify-center md:gap-8 gap-6">
        {/* Header */}
        <h1 className='text-primary pr-6 text-4xl font-mono lowercase font-bold flex justify-center items-center w-full'> <svg className=' w-16 pr-2' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <Link
            to="/login"
            className="btn px-10 py-3 bg-gradient-to-r from-blue-500 to-sky-600 text-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 ease-in-out"
          >
            User Login
          </Link>
          <Link
            to="/admin/login"
            className="btn px-10 py-3 bg-gradient-to-r from-green-400 to-green-600 text-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 ease-in-out"          >
            Admin Login
          </Link>
        </div>
      </div>
